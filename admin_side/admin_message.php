...
<title>Contact Messages — ITPH Admin</title>
...
<div class="dashboard">
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            ...
            <div class="topbar-left">
                ...
                <div>
                    ...
                    <div class="breadcrumb">Home / Messages / Contact Messages</div>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <!-- HERO -->
            <div class="page-hero">
                <div class="hero-eyebrow">Inquiries</div>
                <div class="hero-title">Contact Messages</div>
                <div class="hero-desc">View and manage all incoming contact form submissions from clients.</div>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="message-cell" title="<?= htmlspecialchars($msg['message']) ?>">
                                        <?= htmlspecialchars($msg['message']) ?>
                                    </div>
                                </td>
                                <td><?= htmlspecialchars(date('M d, Y h:i A', strtotime($msg['created_at']))) ?></td>
                            </tr>
                            <?php endforeach; else: ?>
                            <tr>
                                <td colspan="6">
