...
<title>Amani Homes Pavia — ITPH</title>
...
<section class="page-banner">
    <div class="container">
        ...
        <h1 data-aos="fade-up" data-aos-delay="80">Discover <em>Amani Homes</em><br>Pavia, Iloilo.</h1>
...
<div class="properties-layout">
    ...
    <aside class="sidebar">
        ...
        <a href="monticello.php" class="<?= $currentPage === 'monticello.php' ? 'active' : '' ?>">
            <i class="bi bi-houses"></i> Monticello
        </a>
        <a href="amani.php" class="<?= $currentPage === 'amani.php' ? 'active' : '' ?>">
    ...
    <main class="content-area">
        ...
        <?php endwhile; else: ?>
            <div class="empty-state">
                ...
                <p>No Amani properties available at this time.<br>Please check back soon.</p>
            </div>
        <?php endif; ?>
        </div>
    </main>
