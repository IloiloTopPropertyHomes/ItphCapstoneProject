...
/* ===================== INFO CARDS ===================== */
.info-section { padding: 90px 0 60px; background: var(--cream); }
.info-card {
    padding: 40px 32px;
    background: var(--white);
...
/* ===================== MAP SECTION ===================== */
.map-section { padding: 90px 0; background: var(--lightgreen); position: relative; overflow: hidden; }
.map-section::before {
    content: 'FIND US';
    position: absolute;
    left: 50%; top: 50%;
...
<section class="cta-section">
    <div class="container" style="position:relative;z-index:2;">
        ...
        <div class="cta-btns" data-aos="fade-up" data-aos-delay="240">
            ...
            <a href="reservation.php" class="btn-outline-dark">Book Now</a>
        </div>
    </div>
</section>
