...
<section class="page-banner">
    <div class="container">
        ...
        <h1 data-aos="fade-up" data-aos-delay="80">Discover <em>Monticello Homes</em><br>Pavia, Iloilo.</h1>
    ...
    <main class="content-area">
        ...
        <?php endwhile; else: ?>
            <div class="empty-state">
                ...
                <p>No Monticello properties available at this time.<br>Please check back soon.</p>
            </div>
        <?php endif; ?>
        </div>
    </main>
