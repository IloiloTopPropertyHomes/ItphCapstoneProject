...
/* ===================== ARTICLE BODY ===================== */
.article-body-section { background: var(--white); padding: 64px 0 20px; }
...
body.dark-mode .cta-section { background:#1a1a1a; }
...
body.dark-mode .footer { background:#171717; }
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      ...
      <div class="dropdown" style="display:flex; align-items:center; gap:10px;">
        <a href="account.php" title="My Account" style="width:38px;height:38px;border-radius:50%;background:var(--gold);color:#fff;font-size:.75rem;font-weight:600;letter-spacing:.05em;display:flex;align-items:center;justify-content:center;border:2px solid var(--gold-light);text-decoration:none;">
