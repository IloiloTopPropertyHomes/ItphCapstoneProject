...
<div class="properties-layout">
    ...
    <aside class="sidebar">
        ...
        <div class="nav-dropdown <?= $phirstDropdownOpen ?>">
            ...
            <div class="nav-dropdown-menu">
                <a href="phrst-ilo.php?branch=iloilo" data-branch="iloilo"
    ...
    <main class="content-area" id="phirstContent">
        <?php
        if ($phirstBranch !== '') {
            $stmt = $conn->prepare("SELECT * FROM propertiies WHERE property_page='phrst' AND branch='bacolod' ORDER BY id DESC");
            $stmt->execute();
        ...
        <?php endwhile; else: ?>
            <div class="empty-state">
                ...
                <p>No PHIRST properties available<?= $phirstBranch ? ' in ' . htmlspecialchars($branchLabel) : '' ?> at this time.<br>Please check back soon.</p>
                <?php if ($phirstBranch): ?>
                    <a href="phrst.php" class="btn-clear">View all PHIRST branches</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
        </div>
