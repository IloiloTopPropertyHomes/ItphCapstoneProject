...
<div class="location-card">
    ...
    <?php
        $mapLat = $latitude  !== null && $latitude  !== '' ? $latitude  : 10.768065;
        $mapLng = $longitude !== null && $longitude !== '' ? $longitude : 122.483812;
    ?>

    <iframe
        src="https://www.google.com/maps?q=<?= urlencode($mapLat) ?>,<?= urlencode($mapLng) ?>&z=17&output=embed"
        width="100%"
        height="220"
    ...
    <a href="https://www.google.com/maps/dir/?api=1&destination=<?= urlencode($mapLat) ?>,<?= urlencode($mapLng) ?>"
       target="_blank"
